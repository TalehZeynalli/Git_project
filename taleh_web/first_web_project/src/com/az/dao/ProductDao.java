...
public class ProductDao {
	...
	public List<Product> listProducts(String catID, String search, String lang,int limit1, int limit2) throws SQLException {
	...
	public Product findProductById(String productId,String lang) throws SQLException {
		...
		StringBuilder SQL = new StringBuilder("SELECT p.id, p.name,p.image_path, p.price,b.id,b.name,c.id,c.name_"+ lang +"");
		SQL.append(" FROM product p ");
		SQL.append(" INNER JOIN brand b ON p.brand_id = b.id ");
